...
// 고명지 : 처음 다트 언어를 만들어 봤는데요. 일단, 파이썬과 유사하지만 또 다른 언어라서 헷갈리는 부
//        분이 있었습니다. ai의 도움을 받으며 프로그램을 완료하였고, UI 변경을 시도하였습니다.
//        간단하게 될 것 같았는데, 생각보다 쉽지 않았습니다. 그리고 UI에 따라 느낌이 많이 달라져
//        UI의 위대함을 실감했습니다.
// 양건우 : 간단한 기능이지만 어플을 만들어 보았다는 것에서 보람이 있었다. 다른 언어도 마찬가지이지만
//        문장의 시작과 끝을 잘 묶어 주어야 오류를 발생시키지 않는 다는 사실을 확인했다. 많은 부분에
//        서 챗GPT의 도움을 받았지만 요소들을 직접 수정하면서 코드를 이해할 수 있었다. 폰트 작업과
//        기타 세세한 부분을 수정하기 위해서는 웹에서 받아 링크시켜야 하는 것들이 있었기 때문에, 시간
//        관계상 실현 시키지는 못한것이 아쉽다.